                            ...
                            <div class="col-md-6 col-lg-6 col-xl-12">
                                <div class="card bg-primary">
                                    <div class="card-body row">
                                        ...
                                        <div class="col">
                                            <img class="img-fluid" src="{{ asset(' dmin/dist/assets/images/interview.svg ') }}" alt="interview">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="card-body">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                            <div class="d-flex align-items-center flex-fill">
                                                <img class="avatar lg rounded-circle img-thumbnail" src="{{ asset('assets/images/lg/avatar12.jp') }}g" alt="profile">
                                                <div class="d-flex flex-column ps-3">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-10">
                                        <div class="row g-3 row-cols-2 row-cols-sm-3 row-cols-md-3 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-6 row-deck top-perfomer">
                                            ...
                                            <div class="col">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="{{ asset('assets/images/lg/avatar12.jp') }}g" alt="profile">
